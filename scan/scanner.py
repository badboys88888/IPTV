...
# (2052, 2053, 2082, 2083, 2087, 2093, 2096, 8080, 8880, 30001, 30006, 10443, 50001, 20002, 12345, 8081, 40000, 40001, 40002]
# 扫描高位段常用范围
#TARGET_PORTS = list(range(1, 65535)) 
...
ORG_MAP = {
    ...
    "a.i.p. italia": "机房", "enterprise": "企宽", "hong kong broadband": "香港宽频", "cake home": "家宽"
}
